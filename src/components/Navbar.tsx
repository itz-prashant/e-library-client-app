    ...
    <nav className=' border-b'>
        <div className='max-w-7xl mx-auto flex items-center justify-between py-4'>
            <div>
                <Link href={'/'}>
                    <div className='flex items-center gap-1'>
                        ...
                        <span className='text-xl font-bold uppercase tracking-tight text-primary-500'>E-Library Store</span>
                    </div>
                </Link>
            </div>
            <div className='flex items-center gap-4'>
                ...
                <button className='h-10 rounded-md px-4 py-2  text-sm font-medium text-primary-500 transition-all hover:bg-primary-f bg-primary-500 text-white'>
                    Sign up
                </button>
            </div>
        </div>
